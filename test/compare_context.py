...
for n, mod in enumerate(models):
    with open('./data/reps/coords_esm_space'+model_names[n]+'_.pickle','rb') as f:
    ...
    for layer in range(n_layers):
        ...
        print('Done with model '+model_names[n]+' layer '+str(layer))
            
        print(len(mean_comparison))
        ...
        ax.set_title(model_names[n]+' Layer '+str(layer))
